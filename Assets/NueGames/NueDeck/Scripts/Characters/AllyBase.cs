...
namespace NueGames.NueDeck.Scripts.Characters
{
    public abstract class AllyBase : CharacterBase,IAlly
    {
        ...
        public override void BuildCharacter()
        {
            ...
            CharacterStats = new CharacterStats(allyCharacterData,allyCanvas);

            if (!NueGameManager)
                throw new Exception("There is no NueGameManager");
            
            var data = NueGameManager.PersistentGameplayData.AllyHealthDataList.Find(x =>
            ...
            {
                NueGameManager.PersistentGameplayData.SetAllyHealthData(AllyCharacterData.CharacterID,CharacterStats.CurrentHealth,CharacterStats.MaxHealth);
            }
