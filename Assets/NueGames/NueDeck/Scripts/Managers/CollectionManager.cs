...
namespace NueGames.NueDeck.Scripts.Managers
{
    public class CollectionManager : MonoBehaviour
    {
        ...
        public void DrawCards(int targetDrawCount)
        {
            ...
            {
                if (NueGameManager.GameplayData.MaxCardOnHand<=HandPile.Count)
                    return;
                ...
                var clone = NueGameManager.BuildAndGetCard(randomCard, HandController.drawTransform);
        ...
        {
            foreach (var i in NueGameManager.PersistentGameplayData.CurrentCardsList) 
                DrawPile.Add(i);
        }
