...
namespace PixelCrushers.QuestMachine
{
    ...
    public class UnityUIQuestHUD : UnityUIBaseUI, IQuestHUD
    {
        ...
        protected virtual void RefreshNow() //[TODO] Option to toggle/expand groups.
        {
            MakeVisible();

            // Retire current content. May be pulled out of retirement if still needed.
            currentContentManager.RetireInstances(); // Ret
            ...
            currentContentManager.DespawnRetiredInstances();
        }
        ...
        protected virtual void RefreshByGroup()
        {
            ...
            {
                var groupName = StringField.GetStringValue(group);
                var instance = currentContentManager.AcquireTextInstance(questGroupTemplate, groupName);
